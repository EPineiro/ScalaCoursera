...
object squareRoot {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(81); 
  ...
  sqrt(4);System.out.println("""res1: Double = """ + $show(res$1));$skip(13); val res$2 = 
	sqrt(1e-60);System.out.println("""res2: Double = """ + $show(res$2))}
}
